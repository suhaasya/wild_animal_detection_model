...
for image_path in images:
    ...
    for i in range(len(scores)):
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
            ...
            if object_name=="monkey" or object_name=="boar" or object_name=="deer":
                cl.messages.create(body=f'animal is detected', from_='+16813813538', to='+919130606396')            
            ...
            if object_name=="human":
                ...
                cl.messages.create(body=f'human is detected', from_='+16813813538', to='+919130606396')
